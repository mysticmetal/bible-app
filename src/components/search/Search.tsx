...
declare global {
  namespace JSX {
    interface IntrinsicElements {
      'orbit-spinner': React.DetailedHTMLProps<React.HTMLAttributes<HTMLElement>, HTMLElement>;
    }
  }
}

function getList(status: string, results: { content: string; reference: string }[]) {
